...
const Sidebar = ({ onNewChat, onNewGroup, onOpenProfile }) => {
  ...
  return (
    <div className="h-full flex flex-col bg-white dark:bg-surface-darkPanel border-r border-gray-100 dark:border-gray-800">
      ...
      {/* Groups / Direct sections (like WhatsApp's filter chips) */}
          ...
          <button
            ...
            className={`flex-1 py-1.5 rounded-full text-xs font-semibold transition ${
              activeTab === tab.key
                ...
                : "bg-gray-100 dark:bg-surface-dark text-gray-500 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-800"
            }`}
          >
            {tab.label}
          </button>
          ...
          <div className="flex flex-col items-center justify-center py-16 px-6 text-center">
            ...
            <p className="text-gray-400 text-sm">
              {activeTab === "groups"
                ...
                : activeTab === "direct"
                ? "No direct chats yet. Start a new conversation!"
